      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between p-4">
          <div className={cn("flex items-center gap-2", !expanded && "md:hidden")}>
            ...
            {expanded && <span className="font-quicksand font-bold text-lg text-movebem-purple-dark">MoveBem</span>}
          </div>
          <button 
            onClick={toggleSidebar} 
        ...
        <div className="p-4">
          {expanded && (
            <div className="bg-movebem-purple-light/20 rounded-md p-3 text-sm">
